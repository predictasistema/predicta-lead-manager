...
// ──────────────────────────────────────────────────────────────
async function initLeads(sheetId) {
...
// ──────────────────────────────────────────────────────────────
async function initPipeline(sheetId) {
    const sheets = getSheets();
...
async function getSheetId(sheetName) {
    ...
    const sheetId = meta.data.sheets
        ...
        ?.properties?.sheetId;
    if (sheetId == null)
        throw new Error(`Sheet "${sheetName}" non trovato nello spreadsheet`);
    return sheetId;
}
// ──────────────────────────────────────────────────────────────
// Main
...
//# sourceMappingURL=initSheets.js.map